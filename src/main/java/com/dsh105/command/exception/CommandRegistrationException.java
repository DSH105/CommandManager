...
public class CommandRegistrationException extends CommandException {
    ...
    public CommandRegistrationException(String s) {
        super(s);
    }

    public CommandRegistrationException(String s, Throwable throwable) {
        super(s, throwable);
    }

    public CommandRegistrationException(Throwable throwable) {
        super(throwable);
    }
}